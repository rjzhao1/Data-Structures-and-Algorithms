...
//Gets the source of a graph, returns NIL if BFS has not 
//been called yet
...
//Gets the distance of a vertex form the source, returns INF it cannot be
//reached
...
//return a List of the shortest path found by BFS
